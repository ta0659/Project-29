...
function setup(){
    ...
    log19 = new Box(620,430);
    log20 = new Box(585,430);
  
    log21 =new Box(600,390);
    ...
    block11=new Box(880,200)
    block12=new Box(920,200)

    block13=new Box(900,150)
...
function mouseDragged(){Matter.Body.setPosition(hit1.body, {x: mouseX , y: mouseY});}
